...
<p className='text-sm mt-2 mb-6'>The latest news, articles,
    and resources, send to your inbox weekly.
</p>
...
<hr className='border-gray-300 dark:border-gray-600 my-6' />
 ...
 initial={{opacity:0}}
   ...
   justify-center sm:justify-between gap-4 flex-wrap'>
    <p>Copyright 2025 NewnessTechStars - All Right Reserved</p>
