...
const onSubmit = async (event) => {
    ...
    formData.append("access_key", "ff3f65df-69d0-4377-b521-96c434f5ead9");
...
<div>
    ...
    <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
        ...
        <input name='email' type="email" placeholder='Enter your email' required className='w-full p-3 text-sm outline-none'/>
